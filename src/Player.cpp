...
{
    Actor::Init();
    sprite_idle_ = SpriteAnim::AddSpriteAnimChild(this, "assets/sprite/ghost-idle.png", 2.f, Anchar::kCenter);
    sprite_move_ = SpriteAnim::AddSpriteAnimChild(this, "assets/sprite/ghost-move.png", 2.f, Anchar::kCenter);
    sprite_move_->set_active(false);

    collider_ = Collider::AddColliderChild(this, sprite_idle_->size() / 2.f, Collider::Type::kCircle, Anchar::kCenter);
